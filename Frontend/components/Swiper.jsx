...
export default function SwiperCoverflow() {
    const cards = [
        ...
        {
            title: "Capital",
            details: "Capital is a financial consulting firm specializing in investment strategies and wealth management services for high-net-worth individuals and businesses.",
            imagepath: "./Capital.png",
        },
        {
            title: "Gadget",
            details: "Gadget is your ultimate destination for the latest tech gadgets, reviews, and tips. Stay updated with the newest innovations in the world of technology.",
            imagepath: "./Gadget.png",
        },
        {
            title: "Media",
            details: "Media is a digital media production company offering services in video production, animation, and multimedia content creation for businesses and brands.",
            imagepath: "./Media.png",
        },
        {
            title: "Robotics",
